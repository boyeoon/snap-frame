...
export default function OneByTwoLayout({ videoSrc, label, startCamera }: FrameItemProps) {
  ...
  return (
    <div>
      ...
      <div id="frame" className={`px-5 pt-6 pb-16 border border-black ${isBlackBackground ? 'bg-black' : 'bg-white'}`}>
        ...
        <div className="grid grid-cols-1 gap-2">
          {[...Array(4)].map((_, index) => (
            <div
              key={index}
              className="relative w-64 h-48 flex items-center justify-center bg-orange-100 cursor-pointer"
