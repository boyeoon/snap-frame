...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <LifePhoto />
      <footer className="bottom-0 left-0 w-full mb-6 text-center">
        <p>&copy; {new Date().getFullYear()}. Snap Frame. All rights reserved.</p>
        <div className="mt-1">
          <Link href={"https://github.com/boyeoon/snap-frame"} target="_blank" rel="noopener noreferrer" className="hover:underline hover:text-[#cb6872]">GitHub</Link>
        </div>
      </footer>
    </div>
  );
